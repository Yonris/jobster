...
class RecruiterChatListPage extends StatelessWidget {
  const RecruiterChatListPage({super.key});
  ...
  Future<QueryDocumentSnapshot<Map<String, dynamic>>?> _getLastMessage(
    ...
    final messagesSnapshot = await FirebaseFirestore.instance
        ...
        .doc(matchId)
        .collection('messages') // You can add this to constants if reused
  ...
  Widget build(BuildContext context) {
    ...
    final chatStream = matchesRef
        .where(MatchFieldKeys.recruiterId, isEqualTo: currentUserId)
        .snapshots()
